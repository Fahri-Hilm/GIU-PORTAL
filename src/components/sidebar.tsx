    ...
    >
      <div className={cn('px-margin-edge mb-6 flex items-center gap-3', collapse && 'justify-center')}>
        <Link href="/dashboard" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-lg bg-surface-gunmetal/80 border border-border-steel flex items-center justify-center shadow-[0_0_15px_rgba(230,195,131,0.1)] group-hover:border-primary/50 transition-smooth overflow-hidden shrink-0">
